...
def main():
    ...
    landmarks = read_pts(r'C:\Users\wq\eos\examples\data\image_0010.pts')
...
#  Need to remove parameter "model.get_texture_coordinates()".
# =============================================================================
    morphablemodel_with_expressions = eos.morphablemodel.MorphableModel(model.get_shape_model(), blendshapes,eos.morphablemodel.PcaModel())
